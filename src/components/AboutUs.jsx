...
export default function AboutUs() {
    return (
        <div className='grid grid-cols-4 place-items-center'>
            ...
            {/* Section */}
            <div className=' flex flex-col gap-3 text-left mx-7'>
            ...
            {/* Section */}
            <div className='border-x-[0.75em] border-black'>
                <img src="https://scontent-sjc3-1.xx.fbcdn.net/v/t39.30808-6/355363078_9351674868236503_3352577227081706991_n.jpg?_nc_cat=100&ccb=1-7&_nc_sid=8bfeb9&_nc_ohc=ozJZFf3tyD4AX9i1pIy&_nc_ht=scontent-sjc3-1.xx&oh=00_AfBP61QvMe8rPP6aLV1liPYQ70mvvegKBig7AD4xA_7eFg&oe=64D0B6F2" alt="" />
            </div>

            {/* Section */}
            <div className='bg-myaccent2 h-full font-myHeading text-2xl flex flex-col justify-center items-center'>
